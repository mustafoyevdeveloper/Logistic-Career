...
const seedAssignments = async () => {
  try {
    ...
    // Hardcoded testlarni testQuestions.js faylidan olish (yuqorida import qilingan)
    // test40Questions va test40AssignmentData allaqachon import qilingan
    ...
    const existingTest = await Assignment.findOne({ 
      $or: [
        ...
        { type: 'quiz', 'questions.39': { $exists: true } } // 40 ta savol bo'lgan quiz
      ]
    });
    ...
    const test40Assignment = {
      ...
      type: test40AssignmentData.type,
