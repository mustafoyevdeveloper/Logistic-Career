    ...
    topics: {
      ...
      "Telegram gruppalar": {
        ...
        content: `
          ...
          <li>Siz obuna bo’lgan telegram gruppalarga Faqat yuk tashlanadi menda mashina bor deb emas ya’ni A nuqtadan B nuqtada biror bir mahsulot yoki yuk bor deb. Bu gruppalar Ichida kimlar bor Logistlar, Dispecherlar va mashinalar bor. Biz shu grupllardan yuklar gaplashib olamiz vas hu gruppalarag olgan yuklarimizni Shablon kurinishiga keltirib tarqatamiz. </li>
        `,
        videos: []
